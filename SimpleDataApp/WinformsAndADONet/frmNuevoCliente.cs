    ...
    public partial class frmNuevoCliente : Form
    {
        ...
        private void btnCreateAccount_Click(object sender, EventArgs e)
        {
            if (IsCustomerNameValid())
            {
                ...
                using (SqlConnection connection = new SqlConnection(SimpleDataApp.Properties.Settings.Default.connString))
                {
                    ...
                    SqlCommand("Sales.uspNewCustomer", connection))
                    {
                        ...
                        // Add input parameter for the stored procedure and specify
                        // what to use as its value.
                        ...
                        try
                        {
                            ...
                            // Put the Customer ID value into the read-only textbox.
        ...
        private void btnPlaceOrder_Click(object sender, EventArgs e)
        {
            if (IsOrderDataValid())
            {
                ...
                SqlConnection(SimpleDataApp.Properties.Settings.Default.connString))
                {
                    ...
                    {
                        sqlCommand.CommandType = CommandType.StoredProcedure;
                        // Add the @CustomerID input parameter, which was obtaine from uspNewCustomer.
                        ...
                        try
                        {
                            ...
                            MessageBox.Show("Order number " + this.orderID + " hasbeen submitted.");
                        }
                        catch
                        {
